 ...
 * @Version 1.0
 */
public class BuiltInFunctionRight extends BuiltInFunctions {

    public BuiltInFunctionRight() {
        this.name = "right";
        this.variadic = false;
    }
    ...
    public void execute(List<InterpreterDataType> dataTypes) throws InvalidFunctionCallException {
        ...
        String endString = firstString.substring(firstString.length() - length);
